...
- [keyMapFR.sh]() : Dans l'environement graphique Lubuntu il arrive régulierement que l'on commute le clavier fr pour un autre selon la combo de touche que vous avez enfoncé ... ce script rectifie le tir via un alt+tab.
